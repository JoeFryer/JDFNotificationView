...
// JDFNotificationView
#define COCOAPODS_POD_AVAILABLE_JDFNotificationView
#define COCOAPODS_VERSION_MAJOR_JDFNotificationView 0
#define COCOAPODS_VERSION_MINOR_JDFNotificationView 1
#define COCOAPODS_VERSION_PATCH_JDFNotificationView 0
